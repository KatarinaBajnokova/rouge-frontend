  ...
  Y = {
    ...
    encodeByteArray(t, e) {
      ...
      for (let r = 0; r < t.length; r += 3) {
        ...
        let v = ((a & 15) << 2) | (l >> 6),
          y = l & 63;
        h || ((y = 64), o || (v = 64)), s.push(n[x], n[m], n[v], n[y]);
      }
      return s.join('');
    },
    encodeString(t, e) {
      return this.HAS_NATIVE_SUPPORT && !e
        ? btoa(t)
        : this.encodeByteArray(J(t), e);
    },
    decodeString(t, e) {
      return this.HAS_NATIVE_SUPPORT && !e
        ? atob(t)
        : oe(this.decodeStringToByteArray(t, e));
    },
    decodeStringToByteArray(t, e) {
      ...
      for (let r = 0; r < t.length; ) {
        ...
        ++r;
        const m = r < t.length ? n[t.charAt(r)] : 64;
        if ((++r, i == null || a == null || l == null || m == null))
          throw new ae();
        const v = (i << 2) | (a >> 4);
        if ((s.push(v), l !== 64)) {
          const y = ((a << 4) & 240) | (l >> 2);
 ...
 */ const de = () => le().__FIREBASE_DEFAULTS__,
  fe = () => {
    if (typeof process > 'u' || typeof L > 'u') return;
    const t = L.__FIREBASE_DEFAULTS__;
  ...
  Rt = t => {
    var e, n;
    return (n =
      (e = P()) === null || e === void 0 ? void 0 : e.emulatorHosts) === null ||
      n === void 0
      ? void 0
      : n[t];
  },
  X = () => {
    var t;
    return (t = P()) === null || t === void 0 ? void 0 : t.config;
  },
  Nt = t => {
    var e;
    return (e = P()) === null || e === void 0 ? void 0 : e[`_${t}`];
  };
/**
 * @license
 * Copyright 2017 Google LLC
  ...
  constructor(e, n, s) {
    super(n),
      ...
      Error.captureStackTrace &&
        Error.captureStackTrace(this, Z.prototype.create);
  }
}
class Z {
  constructor(e, n, s) {
...
class Ee {
  ...
  subscribe(e, n, s) {
    ...
    _e(e, ['next', 'error', 'complete'])
      ? (r = e)
      : (r = { next: e, error: n, complete: s }),
      r.next === void 0 && (r.next = I),
      r.error === void 0 && (r.error = I),
      r.complete === void 0 && (r.complete = I);
 ...
 */ class Ie {
  ...
  normalizeInstanceIdentifier(e = p) {
    return this.component ? (this.component.multipleInstances ? e : p) : e;
  }
...
class Te {
  ...
  setLogLevel(e) {
    this._logLevel = typeof e == 'string' ? Ce[e] : e;
  }
  get logHandler() {
...
const Me = (t, e) => e.some(n => t instanceof n);
let k, j;
function Re() {
  return (
    k ||
...
function $e(t) {
  ...
  return (
    e
      .then(n => {
        n instanceof IDBCursor && ee.set(n, t);
      })
      .catch(() => {}),
    H.set(e, t),
    e
...
let T = {
  get(t, e, n) {
    if (t instanceof IDBTransaction) {
      if (e === 'done') return O.get(t);
      if (e === 'objectStoreNames') return t.objectStoreNames || te.get(t);
      if (e === 'store')
...
function xe(t) {
  return t === IDBDatabase.prototype.transaction &&
    ...
    ? function (e, ...n) {
        const s = t.call(w(this), e, ...n);
        return te.set(s, e.sort ? e.sort() : [e]), f(s);
      }
    : Ne().includes(t)
      ? function (...e) {
          return t.apply(w(this), e), f(ee.get(this));
        }
      : function (...e) {
          return f(t.apply(w(this), e));
        };
}
function Le(t) {
  return typeof t == 'function'
    ? xe(t)
    : (t instanceof IDBTransaction && Pe(t), Me(t, Re()) ? new Proxy(t, T) : t);
}
function f(t) {
  if (t instanceof IDBRequest) return $e(t);
  if (D.has(t)) return D.get(t);
  const e = Le(t);
  return e !== t && (D.set(t, e), H.set(e, t)), e;
}
const w = t => H.get(t);
function Fe(t, e, { blocked: n, upgrade: s, blocking: r, terminated: i } = {}) {
  const o = indexedDB.open(t, e),
    a = f(o);
  return (
    s &&
      o.addEventListener('upgradeneeded', h => {
        s(f(o.result), h.oldVersion, h.newVersion, f(o.transaction), h);
      }),
    n && o.addEventListener('blocked', h => n(h.oldVersion, h.newVersion, h)),
    a
      .then(h => {
        i && h.addEventListener('close', () => i()),
          r &&
            h.addEventListener('versionchange', l =>
              r(l.oldVersion, l.newVersion, l)
            );
      })
      .catch(() => {}),
    a
...
function U(t, e) {
  ...
  const i = async function (o, ...a) {
    const h = this.transaction(o, r ? 'readwrite' : 'readonly');
    let l = h.store;
    return (
      s && (l = l.index(a.shift())),
      (await Promise.all([l[n](...a), r && h.done]))[0]
    );
  };
  return S.set(e, i), i;
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const d = new Te('@firebase/app'),
  Ve = '@firebase/app-compat',
  We = '@firebase/analytics-compat',
  Ge = '@firebase/analytics',
  Ke = '@firebase/app-check-compat',
  Je = '@firebase/app-check',
  Ye = '@firebase/auth',
  qe = '@firebase/auth-compat',
  Xe = '@firebase/database',
  Qe = '@firebase/data-connect',
  Ze = '@firebase/database-compat',
  et = '@firebase/functions',
  tt = '@firebase/functions-compat',
  nt = '@firebase/installations',
  rt = '@firebase/installations-compat',
  st = '@firebase/messaging',
  it = '@firebase/messaging-compat',
  ot = '@firebase/performance',
  at = '@firebase/performance-compat',
  ct = '@firebase/remote-config',
  ht = '@firebase/remote-config-compat',
  lt = '@firebase/storage',
  dt = '@firebase/storage-compat',
  ft = '@firebase/firestore',
  ut = '@firebase/vertexai',
  pt = '@firebase/firestore-compat',
  mt = 'firebase',
  bt = '11.6.0';
/**
 * @license
 ...
 */ const R = '[DEFAULT]',
  gt = {
    ...
    [Ve]: 'fire-core-compat',
    [Ge]: 'fire-analytics',
    [We]: 'fire-analytics-compat',
    [Je]: 'fire-app-check',
    [Ke]: 'fire-app-check-compat',
    [Ye]: 'fire-auth',
    [qe]: 'fire-auth-compat',
    [Xe]: 'fire-rtdb',
    [Qe]: 'fire-data-connect',
    [Ze]: 'fire-rtdb-compat',
    [et]: 'fire-fn',
    [tt]: 'fire-fn-compat',
    [nt]: 'fire-iid',
...
function $(t) {
  ...
  if (N.has(e))
    return (
      d.debug(`There were multiple attempts to register component ${e}.`), !1
    );
  N.set(e, t);
  for (const n of _.values()) V(n, t);
  for (const n of vt.values()) V(n, t);
  return !0;
}
function Wt(t, e) {
...
function _t(t, e = {}) {
  ...
  const s = Object.assign({ name: R, automaticDataCollectionEnabled: !1 }, e),
    r = s.name;
  if (typeof r != 'string' || !r)
    throw u.create('bad-app-name', { appName: String(r) });
  if ((n || (n = X()), !n)) throw u.create('no-options');
  const i = _.get(r);
  if (i) {
    if (B(n, i.options) && B(s, i.config)) return i;
    throw u.create('duplicate-app', { appName: r });
  }
  const o = new Se(r);
  for (const h of N.values()) o.addComponent(h);
  const a = new Et(n, s, o);
  return _.set(r, a), a;
}
function Jt(t = R) {
  const e = _.get(t);
  if (!e && t === R && X()) return _t();
  if (!e) throw u.create('no-app', { appName: t });
  return e;
}
function C(t, e, n) {
  var s;
  let r = (s = gt[t]) !== null && s !== void 0 ? s : t;
  n && (r += `-${n}`);
  const i = r.match(/\s|\//),
    o = e.match(/\s|\//);
  if (i || o) {
  ...
  $(new E(`${r}-version`, () => ({ library: r, version: e }), 'VERSION'));
}
/**
 * @license
 * Copyright 2021 Google LLC
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const It = 'firebase-heartbeat-database',
  Dt = 1,
  ...
  return (
    A ||
      (A = Fe(It, Dt, {
        ...
        throw u.create('idb-open', { originalErrorMessage: t.message });
      })),
    A
  );
}
async function wt(t) {
  try {
    const n = (await ne()).transaction(b),
      s = await n.objectStore(b).get(re(t));
    return await n.done, s;
  } catch (e) {
    if (e instanceof g) d.warn(e.message);
    else {
...
async function W(t, e) {
  try {
    const s = (await ne()).transaction(b, 'readwrite');
    await s.objectStore(b).put(e, re(t)), await s.done;
  } catch (n) {
    if (n instanceof g) d.warn(n.message);
    else {
      const s = u.create('idb-set', {
  ...
  async triggerHeartbeat() {
    ...
    try {
      ...
      if (
        ...
        this._heartbeatsCache.heartbeats.length > Ct)
      ) {
        const o = Tt(this._heartbeatsCache.heartbeats);
  ...
  async getHeartbeatsHeader() {
    ...
    try {
      if (
        ...
        return '';
      const n = G(),
        { heartbeatsToSend: s, unsentEntries: r } = Bt(
          this._heartbeatsCache.heartbeats
        ),
        i = q(JSON.stringify({ version: 2, heartbeats: s }));
      return (
...
function Bt(t, e = St) {
  ...
  for (const r of t) {
    ...
    if (i) {
      if ((i.dates.push(r.date), K(n) > e)) {
        i.dates.pop();
        break;
      }
    } else if ((n.push({ agent: r.agent, dates: [r.date] }), K(n) > e)) {
      n.pop();
      break;
    }
    s = s.slice(1);
...
function K(t) {
  return q(JSON.stringify({ version: 2, heartbeats: t })).length;
}
function Tt(t) {
 ...
 * limitations under the License.
 */ function Mt(t) {
  $(new E('platform-logger', e => new Ue(e), 'PRIVATE')),
    $(new E('heartbeat', e => new At(e), 'PRIVATE')),
    C(M, z, t),
    C(M, z, 'esm2017'),
    C('fire-js', '');
}
